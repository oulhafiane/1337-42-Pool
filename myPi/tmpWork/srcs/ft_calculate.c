...
/*   Updated: 2018/09/16 21:47:50 by zoulhafi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_calculate_p(char *str)
{
	...
	printf("str = %s , i_first = %d, i_last = %d, nb = %d\n", str, i_first, i_last, nb);
	getchar();
	if (i_first != -1 && i_last != -1)
		nb = call_eval(str, i_first, i_last);
	printf("str = %s , i_first = %d, i_last = %d, nb = %d\n", str, i_first, i_last, nb);
	getchar();
	ft_putstr("================================\n");
...
char	*ft_calculate_mnd(char *str)
{
	...
	nbr[0] = ft_atoi(str + (index[0] ? index[0] + 1 : index[0]));
